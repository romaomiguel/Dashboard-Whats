...
- [x] **Step 1: Instalar dependências de teste**
...
- [x] **Step 3: Criar `vitest.setup.ts`**
...
- [x] **Step 5: Escrever um teste que falha**
...
- [x] **Step 6: Rodar e verificar que passa**
...
- [x] **Step 4: Criar `docs/deploy-evolution.md`**
...
- [x] **Step 6: Verificar que o `.env` não entra no git**
...
- [x] **Step 3: Criar duas contas de teste**
...
- [x] **Step 4: Escrever o teste de RLS**
...
- [x] **Step 5: Instalar o SDK e carregar o `.env` nos testes**
...
- [x] **Step 1: Criar `lib/supabase/server.ts`**
...
- [x] **Step 2: Criar `lib/supabase/client.ts`**
...
- [x] **Step 3: Criar `lib/supabase/admin.ts`**
...
- [x] **Step 4: Escrever o teste do middleware**
...
- [x] **Step 5: Rodar e verificar que falha**
...
- [x] **Step 6: Criar `lib/supabase/middleware.ts`**
...
- [x] **Step 7: Rodar e verificar que passa**

Run: `pnpm test:run lib/supabase/__tests__/middleware.test.ts`
Expected: 5 testes passando.

- [x] **Step 8: Criar `middleware.ts` na raiz**
...
- [x] **Step 1: Escrever o teste do formulário**
...
- [x] **Step 3: Criar `app/login/actions.ts`**
...
- [x] **Step 4: Criar `app/login/formulario-login.tsx`**
...
- [x] **Step 5: Criar `app/login/page.tsx`**
...
- [x] **Step 7: Verificar manualmente**
...
- [x] **Step 1: Escrever o teste dos endpoints**
...
- [x] **Step 3: Criar `lib/evolution/endpoints.ts`**
...
- [x] **Step 5: Escrever o teste do client**
...
- [x] **Step 6: Rodar e verificar que falha**

Run: `pnpm test:run lib/evolution/__tests__/client.test.ts`
Expected: FAIL — módulos não encontrados.

- [x] **Step 7: Criar `lib/evolution/errors.ts`**
...
- [x] **Step 8: Criar `lib/evolution/client.ts`**
...
- [x] **Step 9: Criar `lib/evolution/types.ts`**
...
- [x] **Step 10: Rodar e verificar que passa**
...
- [x] **Step 3: Criar `lib/evolution/instances.ts`**
...
- [x] **Step 1: Escrever o teste da sidebar**
...
- [x] **Step 3: Reescrever `components/sidebar.tsx`**
...
- [x] **Step 5: Criar `components/tela-em-construcao.tsx`**
...
- [x] **Step 6: Criar `app/(app)/layout.tsx`**
...
- [x] **Step 7: Mover a Home para `app/(app)/page.tsx`**
...
- [x] **Step 8: Criar as seis telas em construção**
...
- [x] **Step 9: Atualizar `components/topbar.tsx`**
...
- [x] **Step 10: Verificar o build e a navegação**
...
- [x] **Step 3: Criar `components/dados-exemplo-provider.tsx`**
...
- [x] **Step 4: Criar `components/selo-dados-exemplo.tsx`**
...
- [x] **Step 5: Criar `components/estado-vazio.tsx`**
...
- [x] **Step 6: Adaptar `components/dashboard/stat-cards.tsx`**
...
- [x] **Step 7: Adaptar os outros quatro componentes do dashboard**
...
- [x] **Step 8: Ligar o provider e o selo**
...
- [x] **Step 1: Escrever o teste da rota**
...
- [x] **Step 5: Conferir os endpoints contra a Evolution real**
...
- [x] **Step 6: Registrar o resultado**
...
- [x] **Step 7: Corrigir `endpoints.ts` e `types.ts` se houver divergência**
...
- [x] **Step 3: Percorrer o fluxo manualmente**
...
- [x] **Step 5: Marcar a spec como entregue**
